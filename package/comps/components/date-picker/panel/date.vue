        ...
        <div class="dm-picker-panel__body">
          ...
          <div
            ...
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`dm.datepicker.prevYear`)"
              class="dm-picker-panel__icon-btn dm-date-picker__prev-btn iconfont  icon-xiangzuo">
            </button>
            <button
              type="button"
              @click="prevMonth"
              v-show="currentView === 'date'"
              :aria-label="t(`dm.datepicker.prevMonth`)"
              class="dm-picker-panel__icon-btn dm-date-picker__prev-btn dm__icon--left">
            </button>
            <span
            ...
            <span
              ...
              :class="{ active: currentView === 'month' }">{{t(`dm.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`dm.datepicker.nextYear`)"
              class="dm-picker-panel__icon-btn dm-date-picker__next-btn iconfont  icon-xiangyou">
            </button>
            <button
              type="button"
              @click="nextMonth"
              v-show="currentView === 'date'"
              :aria-label="t(`dm.datepicker.nextMonth`)"
              class="dm-picker-panel__icon-btn dm-date-picker__next-btn dm__icon--right">
            </button>
          </div>
