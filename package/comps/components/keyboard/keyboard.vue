<template>
  <transition name="fade">
	<div class="dm__keyboard" v-if="isVisible" :style="{fontSize: fontSize + 'px' }">
		<div class="dm__mask" @click="maskClose"></div>
    <div class="dm__keyboard--dialog" @touchmove.stop.prevent>
      ...
      <div class="dm__keyboard--content">
        <div class="dm__keyboard--body">
          <ul class="list-wrap">
            ...
            <li class="list-item slidedown" @click="maskClose"><i class="dm__icon--kb-hide"></i></li>
            <!-- <li v-else class="list-item no-bg delete" @click="onDelete($event)"><i class="dm__icon--kb-del"></i></li> -->
          </ul>
        </div>
        <div class="dm__keyboard--operate">
          <ul class="list-wrap">
            <li class="list-item delete" @click="onDelete($event)"><i class="dm__icon--kb-del"></i></li>
